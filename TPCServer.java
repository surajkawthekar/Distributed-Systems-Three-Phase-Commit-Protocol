...
import java.util.*;
		...
		public class TPCServer  extends JFrame
		{
			...
			public TPCServer(){									
				...
				label.setBounds(10, 0, 880, 600);
				
				// This text field will display the clients messages on the server.
				text1 = new JTextArea();			
				text1.setBounds(50, 30, 1250, 650);
				text1.setEditable(false);
				add(text1);
				// code for making the text area scrollable [16]
				scrollable = new JScrollPane(text1,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
				scrollable.setBounds(50, 30, 1250, 650);
				add(scrollable);
	...
	//-[2][3]
			...
			public static void main(String[] args) throws IOException 
			{
				...
				new TPCServer();
				File fl = new File("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\serverbackup.txt");
                if (fl.exists()) {

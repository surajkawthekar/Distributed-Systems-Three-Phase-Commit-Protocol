...
import java.io.IOException;
		...
		//TPCCoordinator class-[2,3,15,17]
		//This lab is built on the previous lab.So it includes all the references of the previous lab 1 and lab2.
		...
		{	
			...
			static boolean recv_coak=false;
			static Socket sock;
			...
			public TPCParticipant(){												
				...
				// code for making the text area scrollable [16]
				
				scrollable = new JScrollPane(DisplayMessage,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
				scrollable.setBounds(50, 50, 1250, 600);
				add(scrollable);
				
				//Button to send the message
				
				button1 = new JButton("PRECOMMIT");		
				...
				button3 = new JButton("ACK");		
				button3.setBounds(950, 680, 130, 25);
		...
		/*Reference https://stackoverflow.com/questions/10274750/java-swing-setting-margins-on-textarea-with-line-border*/
			...
			public void SendMessage()  throws UnknownHostException, IOException {
				...
				String word = "PRECOMMIT";																					   // get the word to search entered by user
			    ...
			    try {  
			        ...
			        fh = new FileHandler("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\log_dump.txt");  
			...
			public void actionPerformed(ActionEvent ae) {																				
				...
				else if (ae.getSource().equals(button3)) {																					
					try {
							SendMessage3();			
					} catch (Exception e) {
						e.printStackTrace();
			...
			//This function will read the message from the clients and write the message on server-2,3
			public void SendMessage3()  throws UnknownHostException, IOException {
				DataOutputStream dos = new DataOutputStream(sock.getOutputStream());
				word = "PARTICIPANT_ACK";																					   // get the word to search entered by user
				dos.writeUTF(encode+word);
			...
			public static void main(String args[]) throws UnknownHostException, IOException 
			{
				...
				while(true) {
    			  ...
    			  //[11,12,13,14]
				    ...
				    {
				    	int id=msg.lastIndexOf(":");
				    	name1= msg.substring(id+1);
				    	...
				    	System.out.println(s);
				    	 //code to read and display the globally committed messages from the file on to the GUI.
				    	 try{
								File fl = new File("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\"+"participant"+s+"_backup.txt");
				                if (fl.exists()) {
					...
					// If the participant receives a VOTE_REQUEST message from the coordinator it will read and display 
					//the string attached with the request message and the timer will start.
					
						if(msg.contains("VOTE_REQUEST")){
							
							//[11,12,13,14]
							//This is the code for pattern matching. It will match the pattern of the string passed by the coordinator and will extract the participant name and 
		    			    // the desired string and will write it to the respective text files of the participant.
							txtmsg ="";
						...
						DataInputStream dis= new DataInputStream(sock.getInputStream());
				            ...
				            public void run() {
							    ...
							    try {  
							        ...
							        // This block configures the logger with handler and formatter and will
							    	//generate a log file and store the participant states in it
							        fh1 = new FileHandler("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\log_dump.txt");  
				                	...
				                	// If the coordinator sends a global abort all the participants will abort the transaction. 
				                	...
				                	if(msg.contains("ACKNOWLEDGEMENT")){
				                		res=25;
				                		recv_coak = true;
				                		...
				                		// If the coordinator sends a global commit all the participants will commit the transaction.
				                		else if(msg.contains("GLOBAL_COMMIT")){
				                			//[10]
				                			File filef3 = new File("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\Participant"+s+"_backup.txt");
					        				...
					        				String savemsg=txtmsg+"\n";
					        				//[10]
					        				Files.write(Paths.get("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\Participant"+s+"_backup.txt"), savemsg.getBytes(), StandardOpenOption.APPEND);
				                		...
				                		
				                	{
										...
										//if msg contains Global_COMMIT write Golbal_COMMIT
										else if(msg.contains("GLOBAL_COMMIT")){
											//[10]
											File filef3 = new File("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\Participant"+s+"_backup.txt");
					        				filef3.createNewFile();
					        			    System.out.println(s);
					        				String Participant_backup= "GLOBAL_COMMIT";
					        				Files.write(Paths.get("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\Participant"+s+"_backup.txt"), txtmsg.getBytes(), StandardOpenOption.APPEND);
					                		msg="";
...
15) Steen, Marteen Van, and Andrew S Tannenbaum. “Distributed Systems.” Distributed System Edition 3, 2017 (Distributed System Edition 3 Book mentioned in lab manual-Pg 487 and 488 pseudo code of 2PC) 
						Third edition Version 3.01 (2017) Maarten van Steen Andrew S. Tanenbaum
16)https://www.quora.com/How-can-I-add-a-scrollbar-to-a-text-area-in-Java/answer/Gul-Zaib

17)Steen, Marteen Van, and Andrew S Tannenbaum. “Distributed Systems.” Distributed System Edition 3, 2017 (Distributed System Edition 3 Book mentioned in lab manual-Pg 489 and 490 of 3PhaseCommit) 
						Third edition Version 3.01 (2017) Maarten van Steen Andrew S. Tanenbaum

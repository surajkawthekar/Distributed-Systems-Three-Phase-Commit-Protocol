...
import java.io.IOException;
		...
		public class TPCCoordinator extends JFrame implements ActionListener
		{
			...
			public TPCCoordinator(){												
				...
				JLabel label1 = new JLabel("===========ThreePhaseCoordinator===========",JLabel.CENTER);
				...
				scrollable.setBounds(50, 50, 1250, 450);
				add(scrollable);
		...
		/*Reference https://stackoverflow.com/questions/10274750/java-swing-setting-margins-on-textarea-with-line-border*/
			...
			public void SendMessage2()  throws UnknownHostException, IOException {	
				File filef2 = new File("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\co-log.txt");
			    ...
			    try {  
			        ...
			        fh = new FileHandler("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\coor_log.txt");  
				...
				int res=20;
		            ...
		            public void run() {
        			    ...
        			    try {  
        			        ...
        			        fh1 = new FileHandler("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\coor_log.txt");  
		                	...
		                	//transaction will be Globally_committed.
			        			...
			        			res=20;
			        				...
			        				Logger logger = Logger.getLogger("MyLog");  
			        			    FileHandler fh;  
			        			    String log2= "ACKNOWLEDGEMENT";
			        			    try {  ;

			        			        // This block configure the logger with handler and formatter  
			        			        fh = new FileHandler("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\Logfile0.txt");  
			        			        logger.addHandler(fh);
			        			        SimpleFormatter formatter = new SimpleFormatter();  
			        			        fh.setFormatter(formatter);  
			        				...
			        				//[10]
			        			    //Files.write(Paths.get("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\co-log.txt"), babloo.getBytes(), StandardOpenOption.APPEND);
			                		
			        				
			        				
			        				
		                		}
		                	    if(msg.contains("PARTICIPANT_ACK")){
		                			counter1++;
		                			msg="";
		                		...
		                		if(counter1==3){
			        			    ...
			        			    //It will create a text file for the coordinator and will print the string once it is globally committed.
			        				//[10]
			        			    String savemsg=babloo+"\n";
			        			    Files.write(Paths.get("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\co-log.txt"), savemsg.getBytes(), StandardOpenOption.APPEND);
			...
			public static void main(String args[]) throws UnknownHostException, IOException 
			{
				...
				while(true) {
					...
					if(msg.contains("myname"))
				    {
				    	...
				    	String name1= msg.substring(id+1);
				    	...
				    	s=s.replace(" ","");
				    	 ...
				    	 try{
								File fl = new File("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\co-log.txt");
				                if (fl.exists()) {

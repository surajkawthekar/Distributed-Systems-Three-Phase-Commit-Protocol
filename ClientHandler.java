		...
		{	
			...
			public void run() {
				...
				while (true) 
				{
						...
						Files.write(Paths.get("D:\\softwares\\eclipse-jee-kepler-SR2-win32-x86_64\\eclipse\\workspace\\ThreePhaseCommit\\serverbackup.txt"), logfile.getBytes(), StandardOpenOption.APPEND);
...
16)Steen, Marteen Van, and Andrew S Tannenbaum. “Distributed Systems.” Distributed System Edition 3, 2017 (Distributed System Edition 3 Book mentioned in lab manual-Pg 489 and 490 of 3PhaseCommit) 
						Third edition Version 3.01 (2017) Maarten van Steen Andrew S. Tanenbaum
		 * */
